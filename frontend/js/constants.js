const contractAddress = "0x39ee98f4891D1541E76EA8eE397726480A5f4b0e"; //Replace with your own contract address
const chain = 'polygon'; // rinkeby or polygon

const welcome_h1 = "Welcome to the Bluemania NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'Mint some cool Blue Footed Boobies and save them.';
